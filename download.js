  ...
  var update = function() {
    if (update_html) {
      ...
      $.each(linkl_list, function() {
        ...
        html = html + '<div class="btn-group"><button type="button" class="btn btn-primary"><strong>İndirme Linkiniz:</strong></button><button type="button" class="btn btn-default"  contenteditable="true" onClick="document.execCommand(&quot;selectAll&quot;,false,null)">' + drive_url + '</button></div>';
      });
